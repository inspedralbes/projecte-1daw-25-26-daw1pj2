...
<div class="container mt-5 pb-5"> <!--con Margin Top: 5-->
    <div class="row justify-content-center align-items-center g-4"> <!-- -->
        <div class="col-12 col-md-5 text-center"> <!-- centrar img + txt -->
            <img src="../img/formularis-incidencies.jpg" alt="imatge" class="img-fluid rounded shadow mb-4" style="max-width:100%; height:auto;">
        </div>

        <div class="col-12 col-md-6 text-center"> <!-- md: medium -->
            <h1 class="fw-bold text-center mb-5">Crear incidència</h1> <!--Color anterior del formulario: background-color: #60c7b6-->
            <form id="formIncidencia" action="InsertIncidUser.php" method="POST" class="border rounded mx-auto w-100" style="max-width:600px; background: linear-gradient(172deg,rgba(96, 199, 182, 1) 0%, rgba(133, 199, 161, 1) 0%, rgba(95, 178, 222, 1) 100%);">
