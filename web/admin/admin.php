...
<div class="container mt-5 pb-5 mb-5">
    ...
    <div class="row w-100 align-items-center text-center">
        ...
        <div class="col d-flex flex-column justify-content-center align-items-center gap-3">
            <div class="col-12 col-sm-6 col-md-4"> <!-- Utilitzem d-block: display:block per fer un salt de linea ¿? mx-auto +  mb-2?-->
                <a href="listTecnics.php" class="btn btn-index" style="color:#278DE6">
                    <img src="../img/technician-icon.png" alt="Llistar Tècnics" class="border border-3 border-primary d-block mx-auto btn-index img-fluid" style="max-width: 200px">TROBA UN TÈCNIC</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a href="listIncidAdmin.php" class="btn rounded btn-index" style="color:#278DE6">
                    <img src="../img/list-icon.png" alt="Llistar Incidències" class="border border-3 border-primary d-block mx-auto btn-index img-fluid" style="max-width: 200px">LLISTAR INCIDÈNCIES</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a href="listIncidPendents.php" class="btn rounded btn-index" style="color:#278DE6">
                    <img src="../img/choosing-icon.jpg" alt="Assignar incidéncies a un tècnic" class="border border-3 border-primary d-block mx-auto btn-index img-fluid" style="max-width: 200px" ; height: 150px;">ASSIGNAR INCIDÈNCIES</a>
            </div>
